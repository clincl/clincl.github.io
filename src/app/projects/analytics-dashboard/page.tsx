          ...
          >
            ...
            <div className="mb-8">
              ...
              <p
                ...
                style={{ color: "var(--text-secondary)" }}
              >
                Advanced data visualization platform with WebSocket streaming
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {["React", "Spring Boot", "WebSockets", "PostgreSQL"].map(
                  (tech) => (
                    <span
                      key={tech}
            ...
            <div className="mb-8">
              ...
              >
                <div className="space-y-4">
                  ...
                  <p>
                    The dashboard processes streaming data through WebSocket
                    connections, providing live updates to multiple connected
                    clients simultaneously. Data flows from various sources
                    through Apache Kafka streams to ensure reliable delivery and
                    processing.
                  </p>
                  ...
                  <p>
                    Built with D3.js and Chart.js, the dashboard offers
                    customizable charts, graphs, and real-time metrics displays.
                    Users can create personalized dashboards with drag-and-drop
                    widgets and custom alert configurations.
                  </p>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    <li>
                      <strong>Data Latency:</strong> Implemented WebSocket
                      compression and message batching to reduce network
                      overhead
                    </li>
                    <li>
                      <strong>Scalability:</strong> Used Redis pub/sub for
                      horizontal scaling of real-time connections
                    </li>
                    <li>
                      <strong>Data Consistency:</strong> Implemented event
                      sourcing with CQRS pattern for reliable state management
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    <li>
                      React frontend with Redux for complex state management
                    </li>
                    <li>Spring Boot microservices with WebSocket support</li>
                  ...
                  <p>
                    The system handles 10,000+ concurrent dashboard users with
                    sub-50ms update latency. Data throughput reaches 100,000
                    events per second with 99.95% message delivery reliability.
                  </p>
                </div>
              </div>
            </div>

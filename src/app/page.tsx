              ...
              >
                ...
                <div className="flex justify-center space-x-3 mt-4 mb-6">
                  <a
                    ...
                    className="flex items-center justify-center p-3 rounded-lg transition-all duration-200 hover:scale-110"
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs" style={{ color: "var(--text-secondary)" }}>chuan.lin.cl@gmail.com</div>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      <div className="font-medium text-sm" style={{ color: "var(--text-primary)" }}>Phone</div>
                      <div className="text-xs" style={{ color: "var(--text-secondary)" }}>347-463-1026</div>
                    </div>
                  </a>
                </div>
              </div>
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <a
                      ...
                      className="inline-flex items-center px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
                      style={{
                        backgroundColor: "var(--accent-primary)",
                        color: "#ffffff",
                      }}
